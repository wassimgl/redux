    ...
    return (
        <div className={completed ? "Todo completed" : "Todo"}>
            ...
            <div style={{ background:'rgb(105, 122, 152)'}}>
                <buttons style={{ background:'rgb(105 122 152)' }} onClick={()=>setIsEditing(true)}>
                update
                    <i style={{ background:'rgb(105, 122, 152)'}} className="editbtn  fas fa-pen"/>
                </buttons>
                <buttons style={{ background:'rgb(105, 122, 152)'}} onClick={removeTodo}> delete
